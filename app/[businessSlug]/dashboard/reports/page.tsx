...
import { Ticket, Armchair, DollarSign, Info } from 'lucide-react'
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
...
export default async function ReportsPage({ params, searchParams }: ReportsPageProps) {
  ...
  // Check if we should show customer-paid fees (controlled by admin toggle)
  const showCustomerPaidFees = business.show_customer_paid_fees ?? false
          ...
          <CardContent>
            <div className="space-y-3">
                      ...
                      <div className="text-xs">
                        ...
                        <div className="p-3 space-y-1.5">
                          <div className="flex justify-between gap-4">
                            <span>Total</span>
                            <span className="font-medium">{analytics.total_orders + analytics.total_table_bookings}</span>
                          </div>
                          ...
                          {analytics.total_table_bookings > 0 && (
                            <div className="flex justify-between gap-4 text-[11px] text-muted-foreground/70">
                              <span className="pl-4">Tables</span>
                              <span>{analytics.total_table_bookings}</span>
                            </div>
                          )}
                        </div>
                      </div>
              ...
              <div className="border-t pt-3 space-y-2">
                ...
                {/* Only show Processing Fees row if there are fees to display */}
                {((businessPaidTicketFees + businessPaidTableFees) > 0 || (showCustomerPaidFees && (customerPaidTicketFees + customerPaidTableFees) > 0)) && (
                <div className="flex justify-between items-center">
                  <TooltipProvider>
                    <Tooltip>
                      <TooltipTrigger asChild>
                      ...
                      <TooltipContent className="p-0 overflow-hidden border border-border" sideOffset={8} hideArrow>
                        <div className="text-xs">
                          ...
                          <div className="p-3 space-y-2">
                            {showCustomerPaidFees && customerPaidTicketPlatformFees > 0 && (
                              <div className="flex items-center justify-between gap-6">
                                <div className="flex items-center gap-2">
                                  <span>Ticket Platform Fee</span>
                            ...
                            {showCustomerPaidFees && customerPaidTicketStripeFees > 0 && (
                              <div className="flex items-center justify-between gap-6">
                                <div className="flex items-center gap-2">
                                  <span>Ticket Stripe Fee</span>
                                  <span className="px-1.5 py-0.5 rounded text-[10px] font-medium bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300">
                                    Customer
                                  </span>
                                </div>
                            ...
                            {showCustomerPaidFees && customerPaidTablePlatformFees > 0 && (
                              <div className="flex items-center justify-between gap-6">
                                <div className="flex items-center gap-2">
                                  <span>Table Platform Fee</span>
                                  <span className="px-1.5 py-0.5 rounded text-[10px] font-medium bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300">
                                    Customer
                                  </span>
                                </div>
                            ...
                            {showCustomerPaidFees && customerPaidTableStripeFees > 0 && (
                              <div className="flex items-center justify-between gap-6">
                                <div className="flex items-center gap-2">
                                  <span>Table Stripe Fee</span>
                                  <span className="px-1.5 py-0.5 rounded text-[10px] font-medium bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300">
                                    Customer
                                  </span>
                                </div>
                  ...
                  <span className="font-medium text-muted-foreground">
                    {(businessPaidTicketFees + businessPaidTableFees) > 0
                      ? `-${formatCurrency(businessPaidTicketFees + businessPaidTableFees)}`
                      : showCustomerPaidFees
                        ? formatCurrency(customerPaidTicketFees + customerPaidTableFees)
                        : formatCurrency(0)}
                  </span>
                </div>
                )}
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-medium text-muted-foreground">
                    {analytics.total_refunds > 0 ? `-${formatCurrency(analytics.total_refunds)}` : formatCurrency(0)}
                  </span>
                </div>
                <div className="flex justify-between items-center border-t pt-2">
                  ...
                  <span className="font-bold">{formatCurrency(totalGrossRevenue)}</span>
                </div>
                <div className="flex justify-between items-center">
                  <TooltipProvider>
                    <Tooltip>
                        ...
                        <div className="text-xs">
                          ...
                          <div className="p-3 space-y-1.5">
                            ...
                            {(businessPaidTicketFees + businessPaidTableFees) > 0 && (
                              <>
                                <div className="flex justify-between gap-4">
                                  ...
                                  <span className="font-medium">-{formatCurrency(businessPaidTicketFees + businessPaidTableFees)}</span>
                                </div>
                            ...
                            <p className="text-[10px] text-muted-foreground pt-1">
                              What you keep after fees & refunds
                            </p>
                          </div>
                        </div>
                      </TooltipContent>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-bold">{formatCurrency(overallTotal)}</span>
                </div>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent>
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                ...
                <span className="font-medium">{analytics.total_tickets_sold}/{totalTicketsAvailable}</span>
              </div>
              <div className="border-t pt-3 space-y-2">
                <div className="flex justify-between items-center">
                ...
                {/* Only show Processing Fees row if there are fees to display */}
                {(businessPaidTicketFees > 0 || (showCustomerPaidFees && customerPaidTicketFees > 0)) && (
                <div className="flex justify-between items-center">
                  <TooltipProvider>
                    <Tooltip>
                      <TooltipTrigger asChild>
                  ...
                  <span className="font-medium text-muted-foreground">
                    {businessPaidTicketFees > 0
                      ? `-${formatCurrency(businessPaidTicketFees)}`
                      : showCustomerPaidFees
                        ? formatCurrency(customerPaidTicketFees)
                        : formatCurrency(0)}
                  </span>
                </div>
                )}
                        ...
                        <div className="text-xs">
                          ...
                          <div className="p-3 space-y-1.5">
                            ...
                            {businessPaidTicketFees > 0 && (
                              <div className="flex justify-between gap-4">
                                <span>- Fees (paid by you)</span>
                                <span className="font-medium">-{formatCurrency(businessPaidTicketFees)}</span>
                              </div>
                            )}
                            {analytics.ticket_refunds > 0 && (
                              <div className="flex justify-between gap-4">
                                <span>- Refunds</span>
                                <span className="font-medium">-{formatCurrency(analytics.ticket_refunds)}</span>
                              </div>
                            )}
                            <div className="flex justify-between gap-4 border-t pt-1.5 font-medium">
                              <span>Net Revenue</span>
          ...
          <CardContent>
            <div className="space-y-3">
              ...
              <div className="border-t pt-3 space-y-2">
                ...
                {/* Only show Processing Fees row if there are fees to display */}
                {(businessPaidTableFees > 0 || (showCustomerPaidFees && customerPaidTableFees > 0)) && (
                <div className="flex justify-between items-center">
                  <TooltipProvider>
                    <Tooltip>
                      <TooltipTrigger asChild>
                  ...
                  <span className="font-medium text-muted-foreground">
                    {businessPaidTableFees > 0
                      ? `-${formatCurrency(businessPaidTableFees)}`
                      : showCustomerPaidFees
                        ? formatCurrency(customerPaidTableFees)
                        : formatCurrency(0)}
                  </span>
                </div>
                )}
                        ...
                        <div className="text-xs">
                          ...
                          <div className="p-3 space-y-1.5">
                            ...
                            {businessPaidTableFees > 0 && (
                              <div className="flex justify-between gap-4">
                                <span>- Fees (paid by you)</span>
                                <span className="font-medium">-{formatCurrency(businessPaidTableFees)}</span>
                              </div>
                            )}
                            {analytics.table_refunds > 0 && (
                              <div className="flex justify-between gap-4">
                                <span>- Refunds</span>
                                <span className="font-medium">-{formatCurrency(analytics.table_refunds)}</span>
                              </div>
                            )}
                            <div className="flex justify-between gap-4 border-t pt-1.5 font-medium">
                              <span>Net Revenue</span>
