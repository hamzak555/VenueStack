...
import { Calendar, MapPin, Ticket, Search, ChevronRight } from 'lucide-react'
import { formatCurrency } from '@/lib/utils/currency'
import { parseLocalDate } from '@/lib/utils'

interface EventWithSalesInfo {
  id: string
  title: string
  event_date: string
...
interface SalesEventSelectorProps {
  events: EventWithSalesInfo[]
  businessSlug: string
}

export function SalesEventSelector({ events, businessSlug }: SalesEventSelectorProps) {
  ...
  const groupedEvents = useMemo(() => {
    const groups: { [key: string]: EventWithSalesInfo[] } = {}
                            ...
                            <div className="flex-shrink-0 text-right">
                              <div className="flex items-center gap-2 justify-end mb-1">
                                ...
                                <span className="text-sm text-muted-foreground">
                                  {event.tickets_sold === 1 ? 'ticket' : 'tickets'} sold
                                </span>
                              </div>
