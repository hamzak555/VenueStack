...
interface TableBookingRefundHistoryProps {
  refunds: TableBookingRefund[]
}

export function TableBookingRefundHistory({ refunds }: TableBookingRefundHistoryProps) {
  if (refunds.length === 0) {
    return null
  }
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          {refunds.length} refund{refunds.length !== 1 ? 's' : ''} processed for this booking
        </CardDescription>
      </CardHeader>
      <CardContent>
